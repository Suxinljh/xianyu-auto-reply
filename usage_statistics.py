...
class UsageStatistics:
    ...
    def __init__(self):
        # 安全改进：默认禁用匿名统计，需显式设置环境变量启用，并使用HTTPS
        import os as _os
        self.enabled = _os.getenv("ENABLE_USAGE_STATISTICS", "false").lower() == "true"
        self.api_endpoint = "https://xianyu.zhinianblog.cn/?action=statistics"  # PHP统计接收端点（HTTPS）
        self.timeout = 5
        self.retry_count = 1
